...
int run(double *S, double *C, int n_beats, double t_sampling, double tol, double *output,
    ...
    //double *S, double *C, int n_beats, double t_sampling, double tol, double *output,
    //        /* can be None -> */ double *output_A, double *output_t, double *stim_protocol
...
/*iur_Ikur4*/ 0.1,  /*funny_yi*/0.0001, /*dl13*/0.01,       /*fl13*/0.001,      /*fca_ecav*/0.001,
/*fca_cav*/0.001,   /*m_11*/0.01,       /*h_11*/0.01,       /*j_11*/0.001};
